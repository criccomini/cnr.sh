...
link: /posts/2009-11-13-sort-reducer-input-value-hadoop
redirects_from: /essays/sort-reducer-input-value-hadoop
template: post
title: Sorting Reducer Input Values in Hadoop
toc:
- level: 1
  slug: sorting-reducer-input-values-in-hadoop
  title: Sorting Reducer Input Values in Hadoop
- level: 2
  slug: sorting-reducer-input-values-in-hadoop_problem-statement
  title: Problem statement
- level: 2
  slug: sorting-reducer-input-values-in-hadoop_sorting-by-value
  title: Sorting by value
- level: 2
  slug: sorting-reducer-input-values-in-hadoop_partitioner
  title: Partitioner
- level: 2
  slug: sorting-reducer-input-values-in-hadoop_output-value-grouping-comparator
  title: Output value grouping comparator
- level: 2
  slug: sorting-reducer-input-values-in-hadoop_output-key-comparator
  title: Output key comparator
- level: 2
  slug: sorting-reducer-input-values-in-hadoop_running-the-job
  title: Running the job
- level: 2
  slug: sorting-reducer-input-values-in-hadoop_output
  title: Output
- level: 2
  slug: sorting-reducer-input-values-in-hadoop_links
  title: Links
