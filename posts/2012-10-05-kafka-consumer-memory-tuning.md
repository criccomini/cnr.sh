...
link: /posts/2012-10-05-kafka-consumer-memory-tuning
redirects_from: /essays/kafka-consumer-memory-tuning
template: post
title: Kafka Consumer Memory Tuning
toc:
- level: 1
  slug: kafka-consumer-memory-tuning
  title: Kafka Consumer Memory Tuning
- level: 2
  slug: kafka-consumer-memory-tuning_buffers
  title: Buffers
- level: 2
  slug: kafka-consumer-memory-tuning_tuning-memory-usage
  title: Tuning memory usage
- level: 2
  slug: kafka-consumer-memory-tuning_what-happened-to-my-process
  title: What happened to my process?
