...
link: /posts/2018-11-05-kafka-change-data-capture-breaks-database-encapsulation
...
toc:
- level: 1
  slug: kafka-change-data-capture-breaks-database-encapsulation
  title: Kafka change data capture breaks database encapsulation
- level: 2
  slug: kafka-change-data-capture-breaks-database-encapsulation_schema-evolution
  title: Schema evolution
- level: 3
  slug: kafka-change-data-capture-breaks-database-encapsulation_schema-evolution_library-api-migrations
  title: Library API migrations
- level: 3
  slug: kafka-change-data-capture-breaks-database-encapsulation_schema-evolution_service-api-migrations
  title: Service API migrations
- level: 2
  slug: kafka-change-data-capture-breaks-database-encapsulation_your-data-model-is-an-api
  title: Your data model is an API
- level: 2
  slug: kafka-change-data-capture-breaks-database-encapsulation_managing-schema-migrations
  title: Managing schema migrations
- level: 3
  slug: kafka-change-data-capture-breaks-database-encapsulation_managing-schema-migrations_source-db-transformations
  title: Source DB transformations
- level: 3
  slug: kafka-change-data-capture-breaks-database-encapsulation_managing-schema-migrations_kafka-source-connector-transformations
  title: Kafka source connector transformations
- level: 3
  slug: kafka-change-data-capture-breaks-database-encapsulation_managing-schema-migrations_kafka-transformations
  title: Kafka transformations
- level: 3
  slug: kafka-change-data-capture-breaks-database-encapsulation_managing-schema-migrations_kafka-sink-connector-transformations
  title: Kafka sink connector transformations
- level: 3
  slug: kafka-change-data-capture-breaks-database-encapsulation_managing-schema-migrations_destination-db-transformations
  title: Destination DB transformations
- level: 3
  slug: kafka-change-data-capture-breaks-database-encapsulation_managing-schema-migrations_private-topics
  title: Private topics
- level: 2
  slug: kafka-change-data-capture-breaks-database-encapsulation_truly-incompatible-changes
  title: Truly incompatible changes
- level: 2
  slug: kafka-change-data-capture-breaks-database-encapsulation_beyond-cdc
  title: Beyond CDC
- level: 2
  slug: kafka-change-data-capture-breaks-database-encapsulation_tools-in-this-area
  title: Tools in this area
...
![source db, kafka, destination db](images/posts/2018-11-05-kafka-change-data-capture-breaks-database-encapsulation/example-data-warehousing.png "CDC example: data warehousing")
