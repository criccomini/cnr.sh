...
link: /posts/2017-08-29-how-paint-bike-shed-kafka-topic-naming-conventions
...
- level: 1
  ...
  title: Kafka Topic Naming Conventions
- level: 2
  slug: kafka-topic-naming-conventions_convention-types
  title: Convention types
- level: 2
  slug: kafka-topic-naming-conventions_potential-fields
  title: Potential fields
- level: 2
  slug: kafka-topic-naming-conventions_don-t-do-this
  title: Don't do this
- level: 3
  slug: kafka-topic-naming-conventions_don-t-do-this_don-t-use-fields-that-change
  title: Don't use fields that change
- level: 3
  slug: kafka-topic-naming-conventions_don-t-do-this_don-t-use-fields-if-data-is-available-elsewhere
  title: Don't use fields if data is available elsewhere
- level: 3
  slug: kafka-topic-naming-conventions_don-t-do-this_don-t-tie-topic-names-to-consumers-or-producers
  title: Don't tie topic names to consumers or producers
- level: 2
  slug: kafka-topic-naming-conventions_do-this
  title: Do this
- level: 2
  slug: kafka-topic-naming-conventions_enforcing-the-rules
  title: Enforcing the rules
- level: 2
  slug: kafka-topic-naming-conventions_conclusion
  title: Conclusion
